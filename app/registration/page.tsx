    ...
    <div className="min-h-screen bg-[#f8fafc] py-12 px-4 relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto relative z-10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Створення закладу</h1>
          <p className="text-gray-500 mt-2">Пройдіть 4 простих кроки, щоб запустити ваше онлайн-меню</p>
        </div>
