    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      <div className="flex flex-col items-center gap-6">
        <div className="relative group cursor-pointer">
          <img src={logoPreview || 'https://via.placeholder.com/150?text=Logo'} className="w-32 h-32 rounded-[2rem] object-cover border-4 border-gray-50 shadow-md group-hover:opacity-80 transition-all" />
        ...
        <p className="text-sm text-gray-400">Натисніть, щоб завантажити логотип закладу</p>
      </div>

      <div className="bg-gray-50 p-6 rounded-3xl space-y-4">
        <div className="flex items-center gap-2">
          <Palette size={18} className="text-blue-600" />
          <h3 className="font-bold">Фірмовий колір</h3>
        </div>
        <div className="flex items-center gap-4">
          ...
          <p className="text-sm text-gray-500">Цей колір буде головним акцентом вашого цифрового меню</p>
        </div>
      </div>
